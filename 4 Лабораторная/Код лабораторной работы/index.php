...
<body>
		...
		<div class="container">
			<div class="menu">
				<div class="list-menu">
					...
					<a href="info.html" class="menu-link">Об учреждении</a>
					<a href="usluga.html" class="menu-link">Платные услуги</a>
				</div>
			</div>
		</div>
	</header>
	<div class="container">
		...
		<div class="index-form">
			...
			<form action='./send-doctor.php' class="form-index" id="form" method="post">
